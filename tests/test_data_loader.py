...
from chicago_crimes.data_loader import (
    load_data, get_feature_columns, load_location_mapping, 
    prepare_features, create_dataset
)
    ...
    def test_load_location_mapping(self):
        ...
        with patch('builtins.open', mock_open(read_data=mock_json_content)):
            with patch('json.load') as mock_json_load:
                mock_json_load.return_value = {"STREET": "Street/Public", "RESIDENCE": "Residential"}
