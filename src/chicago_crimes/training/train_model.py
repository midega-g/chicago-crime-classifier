from chicago_crimes.config import VAL_DATA_PATH, TRAIN_DATA_PATH
from chicago_crimes.data_loader import create_dataset, load_location_mapping
from chicago_crimes.model_trainer import save_model, train_model, create_xgb_pipeline
...
def main():
    ...
    _ = evaluate_model(pipeline, X_train_dict, y_train, "Training")
    ...
    try:
        ...
        _ = evaluate_model(pipeline, X_val_dict, y_val, "Validation")
