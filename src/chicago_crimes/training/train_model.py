...
from chicago_crimes.model_trainer import create_xgb_pipeline, save_model, train_model
...
def main():
    ...
    evaluate_model(pipeline, X_train_dict, y_train, "Training")
    ...
    try:
        ...
        evaluate_model(pipeline, X_val_dict, y_val, "Validation")
